...
import { ICard, ILanguage } from '../../models/card';
import { BehaviorSubject, Subject } from 'rxjs';
import { defaultSort } from '../sorting-panel/sorting-panel.component';
...
const items: ICard[] = [
    {
      ...
      snippet: {
        ...
        defaultAudioLanguage: ILanguage.en
      },
      statistics: {
        viewCount: '33265',
        likeCount: '1173',
    ...
    },
    {
      ...
      snippet: {
        ...
        defaultAudioLanguage: ILanguage.ru
      },
      statistics: {
        viewCount: '33896',
        likeCount: '612',
...
export class CardListService {
  ...
  constructor() {
    this.search$.subscribe((value: string) => this.items$.next(value ? items : []));
  }
}
